...
@Component({
  selector: 'block-personal-info',
  templateUrl: './block-personal-info.component.html',
  styleUrls: ['./block-personal-info.component.scss']
})
export class BlockPersonalInfoComponent implements OnInit {
