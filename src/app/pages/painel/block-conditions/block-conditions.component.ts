...
@Component({
  ...
  selector: 'block-conditions',
  templateUrl: './block-conditions.component.html',
  styleUrls: ['./block-conditions.component.scss']
})
export class BlockConditionsComponent implements OnInit, OnDestroy {
