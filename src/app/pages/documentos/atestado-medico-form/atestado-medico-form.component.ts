...
@Component({
  selector: 'app-atestado-medico-form',
  templateUrl: './atestado-medico-form.component.html',
  styleUrls: ['./atestado-medico-form.component.scss']
})
export class AtestadoMedicoFormComponent implements OnInit {
